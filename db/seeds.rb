...
estudiante =  Estudiante.new(:direccion=> 'Avenida siempre viva no. 221', :telefono=> '3323223', :tipo=> 'maestria')
estudiante.usuario = Usuario.first
estudiante.maestria << maestrias.first
estudiante.save

estudiantesmaestrias = Estudiantemaestria.create([{estado:'En curso',carpeta:'Carpeta MISIS Lisa Simpson', estudiante: estudiante, maestria: maestrias.first, pensum: pensums.first }])

coordinador = Coordinador.new :apellido=> 'Moyano', :documento=> '123456', :login=> 'gf.moyano131', :nombre=> 'Felipe', :tipo_documento=> 'cedula'
coordinador.save
